...
== Grammar
  ...
  start_state           = program
  program               = [namespace declaration], line break, definition
  namespace declaration = 'namespace', white space, identifier, [white space], '=', [white space], uri reference,
                          [line break namespace decleration]
S ->	A				
A	-> N | D				
